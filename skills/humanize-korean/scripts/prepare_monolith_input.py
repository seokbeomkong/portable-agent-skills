...
# Resolve the installed Skill independently of the user's current workspace.
# Codex and ChatGPT may install this directory outside the active project.
...
def _resolve_run_dir(run_dir_arg: str | None, text_arg: str | None) -> Path:
    ...
    workspace = WORKSPACE_ROOT / ".humanize-korean"
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.diagnosis:
        ...
        if not diag_path.is_absolute():
            diag_path = WORKSPACE_ROOT / diag_path
